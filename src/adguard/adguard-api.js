...
(function (window, undefined) {
    ...
    ! function () {
        ...
        var n, e, r, t, u, o, i, l, s, a, c, f, p, h, y = [].slice;
        u = "3.0.0", e = "pending", t = "resolved", r = "rejected", s = function (n, e) {
            return null != n ? n.hasOwnProperty(e) : void 0
        }, c = function (n) {
            return s(n, "length") && s(n, "callee")
        }, f = function (n) {
            return s(n, "promise") && "function" == typeof (null != n ? n.promise : void 0)
        }, l = function (n) {
            ...
            var t, u, o, i, s;
            for (i = l(n), s = [], u = 0, o = i.length; o > u; u++) t = i[u], s.push(t.call.apply(t, [r].concat(y.call(e))));
            return s
        }, n = function () {
            var u, o, s, a, c, p, h;
            return h = e, a = [], c = [], p = [], s = {
                ...
                rejected: {},
                pending: {}
            }, this.promise = function (u) {
                var o, d;
                return u = u || {}, u.state = function () {
                    return h
                }, d = function (n, r, t) {
                    return function () {
                        return h === e && r.push.apply(r, l(arguments)), n() && i(arguments, s[t]), u
                    }
                }, u.done = d(function () {
                    return h === t
                }, a, t), u.fail = d(function () {
                    return h === r
                }, c, r), u.progress = d(function () {
                    return h !== e
                }, p, e), u.always = function () {
                    var n;
                    return (n = u.done.apply(u, arguments)).fail.apply(n, arguments)
                }, o = function (e, r, t) {
                    var o, i;
                    return i = new n, o = function (n, e, r) {
                        return r ? u[n](function () {
                            var n, t;
                            return n = 1 <= arguments.length ? y.call(arguments, 0) : [], t = r.apply(null, n), f(t) ? t.done(i.resolve).fail(i.reject).progress(i.notify) : i[e](t)
                        }) : u[n](i[e])
                    }, o("done", "resolve", e), o("fail", "reject", r), o("progress", "notify", t), i
                }, u.pipe = o, u.then = o, null == u.promise && (u.promise = function () {
                    return u
                }), u
            }, this.promise(this), u = this, o = function (n, r, t) {
                return function () {
                    return h === e ? (h = n, s[n] = arguments, i(r, s[n], t), u) : this
                }
            }, this.resolve = o(t, a), this.reject = o(r, c), this.notify = o(e, p), this.resolveWith = function (n, e) {
                return o(t, a, n).apply(null, e)
            }, this.rejectWith = function (n, e) {
                return o(r, c, n).apply(null, e)
            }, this.notifyWith = function (n, r) {
                return o(e, p, n).apply(null, r)
            }, this
        }, h = function () {
            var e, r, t, u, i, s, a;
            ...
            for (u = [], t = o(r.length, function () {
                ...
                return f(n) ? n.done(function () {
                    var n;
                    return n = 1 <= arguments.length ? y.call(arguments, 0) : [], u[e] = n.length > 1 ? n : n[0], t()
                }) : (u[e] = n, t())
            }), s = 0, a = r.length; a > s; s++) e = r[s], f(e) && e.fail(i.reject);
            return i.promise()
        }, a = function (e) {
            return e.Deferred = function () {
                ...
                return null == r && (r = {}), u = new n, t = function (n, e) {
                    return p(n, function () {
                        var n, r;
                        return r = arguments[0], n = 2 <= arguments.length ? y.call(arguments, 1) : [], r && r.apply(null, n), e.apply(null, n)
                    })
            ...
            return new n
        }, exports.when = h, exports.installInto = a) : "function" == typeof define && define.amd ? define(function () {
            return "undefined" != typeof Zepto ? a(Zepto) : (n.when = h, n.installInto = a, n)
        }) : "undefined" != typeof Zepto ? a(Zepto) : (this.Deferred = function () {
            return new n
        }, this.Deferred.when = h, this.Deferred.installInto = a)
    }.call(this);
    ...
    adguard.utils.RingBuffer = function (size) { // jshint ignore:line
        ...
        while (i--) {
            ringBuffer[i] = {
                processedKey: null
            }; // 'if not null' means this item hasn't been processed yet.
        }
    ...
    (function (api, global) {
        ...
        var UrlUtils = {
            ...
            getCroppedDomainName: function (host) {
                return api.strings.startsWith(host, "www.") ? host.substring(4) : host;
            },
    ...
    adguard.backend = (function (adguard) {
        ...
        function executeRequestAsync(url, contentType, successCallback, errorCallback) {
            ...
            try {
                ...
                // if (url.indexOf("/filters.json") <= 0 && url.indexOf("/filters_i18n.json") <= 0) {
        ...
        function getUrlForDownloadFilterRules(filterId, useOptimizedFilters) {
            ...
            for(var i=0;i<adguard.filters.metadata.length;i++){
              if(adguard.filters.metadata[i].filterId === filterId){
                return adguard.filters.metadata[i].subscriptionUrl;
              }
            }
        ...
        var loadLocalFiltersMetadata = function (successCallback, errorCallback) {
            ...
            var url = settings.filtersUrl + '/filters.json';
            executeRequestAsync(url, 'application/json', success, errorCallback);
        };
        ...
        var loadLocalFiltersI18Metadata = function (successCallback, errorCallback) {
            ...
            var url = settings.filtersUrl + '/filters_i18n.json';
            executeRequestAsync(url, 'application/json', success, errorCallback);
        };
        ...
        var loadLocalScriptRules = function (successCallback, errorCallback) {
            ...
            var url = adguard.getURL(settings.filtersUrl + '/local_script_rules.json');
            executeRequestAsync(url, 'application/json', success, errorCallback);
        };
        ...
        var defaultProperties = {
            get defaults() {
                return adguard.lazyGet(this, 'defaults', function () {
                    ...
                    defaults[settings.DISABLE_SEND_SAFEBROWSING_STATS] = false;
    ...
    adguard.tabsImpl = (function (adguard) {
        ...
        var activate = function (tabId, callback) {
            ...
            browser.tabs.update(tabIdToInt(tabId), {
                active: true
            }, function (chromeTab) {
        ...
        var reload = function (tabId, url) {
            if (url) {
                ...
                if (browser.tabs.reload) {
                    browser.tabs.reload(tabIdToInt(tabId), {
                        bypassCache: true
                    }, checkLastError);
                } else {
    ...
    (function (adguard) {
        ...
        adguard.tabs = (function (tabsImpl) {
            ...
            var getTabMetadata = function (tabId, key) {
                var tab = tabs[tabId];
                if (tab != undefined && tab.url != undefined && tab.url.startsWith(chrome.runtime.getURL("popup.html").replace("/popup.html", "")) && key == "frameWhiteListRule") {
                    return {
                        filterId: 100,
                        isRegexRule: false,
                        permittedContentType: 7340032,
                        restrictedContentType: 0,
                        ruleText: "@@//*.cloudopt.net$document",
                        shortcut: ".cloudopt.net",
                        urlRegExp: /\/\/.*\.cloudopt\.net/i,
                        whiteListRule: true,
            ...
            loadDomains: function (domains) {
                ...
                try {
                    for (var i = 0; i < parts.length; i++) {
                        var domain = parts[i],
                            domainName;
                        if (adguard.utils.strings.startsWith(domain, "~")) {
    ...
    (function (adguard, api) {
        ...
        function parseRuleDomain(ruleText, parseOptions) {
            try {
                ...
                for (i = 0; i < startsWith.length; i++) {
                    ...
                    if (adguard.utils.strings.startsWith(ruleText, start)) {
        ...
        function parseRuleText(ruleText) {
            ...
            if (adguard.utils.strings.startsWith(urlRuleText, api.FilterRule.MASK_WHITE_LIST)) {
            ...
            if (adguard.utils.strings.startsWith(urlRuleText, api.UrlFilterRule.MASK_REGEX_RULE) &&
        ...
        var UrlFilterRule = function (rule, filterId) {
            ...
            this.isRegexRule = adguard.utils.strings.startsWith(urlRuleText, UrlFilterRule.MASK_REGEX_RULE) &&
    ...
    (function (adguard, api) {
        ...
        var createRule = function (ruleText, filterId) {
            ...
            try {
                ...
                if (StringUtils.startsWith(ruleText, api.FilterRule.COMMENT) ||
                ...
                if (StringUtils.startsWith(ruleText, api.FilterRule.MASK_WHITE_LIST)) {
    ...
    adguard.antiBannerService = (function (adguard) {
        ...
        function getAllAdguardFilters() {
            ...
            filters.push(createAdguardFilter({
                filterId: adguard.utils.filters.USER_FILTER_ID
            }));
            filters.push(createAdguardFilter({
                filterId: adguard.utils.filters.WHITE_LIST_FILTER_ID
            }));
        ...
        function handleMessage(message, sender, callback) {
            switch (message.type) {
                ...
                case 'checkRequestFilterReady':
                    return {
                        ready: adguard.requestFilter.isReady()
                    };
                ...
                case 'getTabFrameInfoById':
                    if (message.tabId) {
                        var frameInfo = adguard.frames.getFrameInfo({
                            tabId: message.tabId
                        });
                        return {
                            frameInfo: frameInfo
    ...
    (function (adguard) {
        ...
        if (adguard.integration.isSupported() && adguard.utils.browser.isChromium()) {
            ...
            browser.webRequest.onBeforeSendHeaders.addListener(function callback(details) {
                ...
                return {
                    ...
                    urls: [adguard.integration.getIntegrationBaseUrl() + "*"]
                }, ["requestHeaders", "blocking"]);
        }
        ...
        (function fastScriptRulesLoader(adguard) {
            ...
            adguard.webNavigation.onCommitted.addListener(function (tabId, frameId, url) {
                ...
                var result = adguard.webRequestService.processGetSelectorsAndScripts({
                    tabId: tabId
                }, url, {
                        filter: ['scripts']
                    });
    ...
    (function (adguard, global) {
        ...
        var start = function (configuration, callback) {
            ...
            adguard.backend.loadFiltersMetadata(configuration.filters,function(filterMetadataList){
              adguard.filters.metadata = filterMetadataList;
